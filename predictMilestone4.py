...
if TRIPLET_LOSS_MODEL:
    ...
    #prediction_1 = siamese_model.predict([database_list_1, image_list_1, image_list_1])
    #prediction_2 = siamese_model.predict([database_list_2, image_list_2, image_list_2])
...
for t in [0.2, 0.4, 0.6, 0.8]:
    ...
    pred = evaluateTestsetTripletLoss(t, images_db, database_list, r"C:\Users\Svea Worms\PycharmProjects\Face-Detection\images\milestone4\test", False, siamese_model)
